...
//login/signup switching in small screens 
const switchBtn = document.querySelector('.switch-form-btn');
const switchLinks = document.querySelectorAll('.switch-link');

function toggleForms() {
    container.classList.toggle('active');
    const isLogin = container.classList.contains('active');
    switchBtn.textContent = isLogin ? 'Switch to Login' : 'Switch to Signup';
}
