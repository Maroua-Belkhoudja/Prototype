    ...
    if (menuToggle && navContainer) {
        ...
        const translations = {
            en: {
                ...
                heroSubtitle: "Connecting talented professionals with top employers worldwide",
                jobSeekers: "Job Seekers",
                employers: "Employers",
            },
            fr: {
                heroTitle: "Trouvez Votre Emploi de Rêve Aujourd'hui",
                heroSubtitle: "Connecter des professionnels talentueux avec les meilleurs employeurs",
                jobSeekers: "Chercheurs d'emploi",
                employers: "Employeurs",
            },
            ar: {
                heroTitle: "ابحث عن وظيفة أحلامك اليوم",
                heroSubtitle: "ربط المحترفين الموهوبين بأفضل أصحاب العمل في العالم",
